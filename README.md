...
*see **code for ggplots and tables** for better understanding of this table

4B) Company Comparison Table (Worst Performing Financial Institutions) 
...
1) Companies Performance by State (Fully Interactive in Shinyapp)
...
4) Company Comparison Table (Fully interactive in Shinyapp)
* While the tables in the **Data Analysis** section show the 5 best and worst companies, the actual table generated by this code allows you to see the sentiment score for all 2,000+ companies.
