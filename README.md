...
* While the tables in the **Data Analysis** section show the 5 best and worst companies, the actual table generated by this code allows you to see the sentiment score for all 2,000+ companies in either descending or ascending order
